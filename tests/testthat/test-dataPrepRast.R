test_that("dataPrepRast produces correct output", {
  ...
  ##TEST CROP
  x <- dataPrepRast(inputrast, cropWith = canada, maskWith = NULL,
                    reprojectTo = inputrast,  timings = FALSE)
  ...
  x <- dataPrepRast(inputrast, cropWith = canada, maskWith = canada,
                    reprojectTo = inputrast,  timings = FALSE)
  y <- dataPrepRast(inputrast, cropWith = canadaTransform, maskWith = canadaTransform,
                    reprojectTo = inputrast,  timings = FALSE)
  ...
  expect_error(dataPrepRast(inputrast, cropWith = mexico, maskWith = mexico,
                            reprojectTo = inputrast, timings = FALSE))
